...
<!--
themes: flatly, lumen, paper, sandstone, simplex, spacelab, united
highlight: tango, pygments, kate, monochrome, espresso, zenburn, haddock, breezedark, textmate
...
<!-- 
You don't need to edit the setup chunk unless you know what the various options with it mean.
Feel free to add/remove packages from the load_packages chunk as you see fit.
-->
